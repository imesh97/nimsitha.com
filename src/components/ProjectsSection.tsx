    ...
    return (
        <div className="pb-28 md:pb-32 px-10">
            <div className="text-center">
                <div className="flex justify-center items-center text-5xl text-primary dark:text-light mb-6 font-semibold tracking-wider"><TbStack2 className="mx-3" />Projects</div>
